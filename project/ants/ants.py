...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        distance = 0
        while location != hive:
            if len(location.bees) > 0 and distance >= self.min_range and distance <= self.max_range:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        bee_place = list(self.place.bees)
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, colony):
        ...
        if self.imposter == True:
            ...
            location = self.place
            location1 = self.place
            while location.entrance != None:
                if location.ant != None:
                    if location.ant.doubled != True:
                        location.ant.doubled = True
                        location.ant.damage = location.ant.damage * 2
                    if location.ant.container:
                        if location.ant.ant != None:
                            if location.ant.ant.doubled == False:
                                location.ant.ant.damage *= 2
                                location.ant.ant.doubled = True
                location = location.entrance
            
            while location1.exit != None:
                if location1.ant != None:
                    if location1.ant.doubled != True:
                        location1.ant.doubled = True
                        location1.ant.damage = location1.ant.damage * 2
                    if location1.ant.container:
                        if location1.ant.ant != None:
                            if location1.ant.ant.doubled == False:
                                location1.ant.ant.damage *= 2
                                location1.ant.ant.doubled = True
                location1 = location1.exit  
