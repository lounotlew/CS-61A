def make_change(amount, coins):
    ...
    old_amount, sum_of_coins = amount, []

    if smallest > amount:
        return None

    elif smallest == amount:
        sum_of_coins.append(smallest)
        return sum_of_coins

    else:
        sum_of_coins.append(smallest)
        amount = amount - smallest
        remove_one(coins, smallest)
        next_coin = make_change(amount, rest)
        ...
        sum_of_coins = sum_of_coins + next_coin
...
class ChangeMachine:
    ...
    def change(self, coin):
        ...
        coin_sums = make_change(coin, self.coins)
